...
#             t=t_key+t_value
    ...
    def calc_grid_rate(self):#统计每个格子的上车率、下车率、上车率-下车率
        ...
        onrate_csv= file('statisticGridAll900_onrate_m.csv', 'wb')
        offrate_csv= file('statisticGridAll900_offrate_m.csv', 'wb')
        diffrate_csv= file('statisticGridAll900_diffrate_m.csv', 'wb')
...
#                 fullcou-=oncou
                ...
                off_on_differ=off_rate-on_rate
